...
//
// These are the well-known PeSTO tables (public domain, derived from
// Rofchade), which are tuned together with the PeSTO material values in
...
public static class PieceSquareTables
{
    ...
    private static readonly int[][] MgByPiece =
        [PawnMg, KnightMg, BishopMg, RookMg, QueenMg, KingMg];
    private static readonly int[][] EgByPiece =
