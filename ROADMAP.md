...
|---------|----------|--------|
| **5.8.5** | **SHIPPED 2026-09-08: quiescence tries the checks.** `QsChecks` ON (checking quiets at the first quiescence ply): fixed-node SPRT +6.3 +/- 6.5, LLR +1.20 (LOS 97.2%, stopped and promoted by the user's call, the [0, 10] bounds would not close either way), H1 over 4,993 games, the slowest verdict of the campaign. Bench 9,084,675; 441 tests. |
