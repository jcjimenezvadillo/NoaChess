...
**The package of the three slow positives closed H1: +11.8 +/- 9.4, LLR +3.00 over 2,259 games against v5.9.12, and ships ON in v5.9.14** - none of the three closed alone. `HindsightReset` with `LmrDeeperResearch` (the reference's configuration of the two): -7.1 over 1,025, LLR -2.55, cut near H0; both options leave the engine.
