...
**Versión actual: v2.8.0 — ~2975 ± 25 CCRL (SPRT pendiente)** (tablebases Syzygy: resultado exacto con cinco piezas o menos, consultadas dentro de la búsqueda y usadas para filtrar las jugadas de raíz por distancia al cambio irreversible, de modo que los finales ganados se conviertan de verdad. Port nativo en C#, verificado contra un prober independiente sobre 3000 finales aleatorios sin una sola discrepancia). Ver [CHANGELOG](CHANGELOG.md).
