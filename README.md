...
**Current version: v2.7.0 — ~2965 ± 25 CCRL** (5A improving flag — the per-ply static-eval trend gates LMR, reverse futility and late move pruning; opens the reference-search block. +43 ± 23 relative in the LTC gauntlet vs the +16 of v2.6.9 on the identical field: search gains GROW with the time control). See [CHANGELOG](CHANGELOG.md).
...
**Versión actual: v2.7.0 — ~2965 ± 25 CCRL** (bloque 5A: improving flag — la tendencia del eval estático por ply modula LMR, reverse futility y late move pruning; abre el bloque de búsqueda de referencia. +43 ± 23 relativo en el gauntlet LTC frente a los +16 de la v2.6.9 con campo idéntico: las ganancias de búsqueda CRECEN con el ritmo). Ver [CHANGELOG](CHANGELOG.md).
