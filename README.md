...
**Current version: v2.8.3 — +24.4 ±17.5 Elo vs v2.8.2 (835 games, interval excluding zero; the run was stopped by hand at LLR 2.61 against a 2.94 bound, so it is not a formally accepted H1); LTC gauntlet +112 ±24 relative to the field** (working gravity for the butterfly history table — the v2.8.2 version was numerically inert at a 2²⁰ bound — plus a fixed-point LMR pipeline, verified behaviour-neutral). See [CHANGELOG](CHANGELOG.md).
