...
- **Next** — reference search block (double extensions, ProbCut/IIR, TT clustering, capture history, aspiration) · Syzygy tablebases (before NNUE — reference order: in-play endgame strength + datagen adjudication/WDL relabeling) · NNUE training · Lazy SMP · competition book last · see [ROADMAP.md](ROADMAP.md).
...
- **Siguiente** — Bloque 5: búsqueda de referencia (double extensions, ProbCut/IIR, TT clustering, capture history, aspiration) · Tablebases Syzygy (antes del NNUE — orden de la referencia: fuerza en finales ya + adjudicación/re-etiquetado WDL del datagen) · Entrenamiento NNUE · Lazy SMP · libro de competición al final · ver [ROADMAP.md](ROADMAP.md).
