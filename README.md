...
**Current version: v2.7.4 — ~2975 ± 25 CCRL** (quiescence rework, a correctness release: in-check nodes are no longer stand-patted, SEE-pruned or scored without mate detection, plus a stalemate guard and a fix for a terminal-root hang that froze the engine on mate/stalemate positions. WAC 269/300, a new record; strength unchanged — SPRT −2.1 ± 9.9 (H0) and LTC gauntlet +52 ± 23 against v2.7.2's +48 on the identical field). See [CHANGELOG](CHANGELOG.md).
...
- **Next** — **Syzygy tablebases (v2.8.0)**, deliberately before NNUE (reference order: in-play endgame strength now, plus datagen adjudication and WDL relabelling later) · NNUE training · Lazy SMP · competition book last · see [ROADMAP.md](ROADMAP.md).
...
**Versión actual: v2.7.4 — ~2975 ± 25 CCRL** (rework de la quiescence, versión de corrección: en jaque ya no se hace stand-pat, ni se podan las evasiones por SEE, ni se ignora el mate; más un guard de ahogado y el arreglo de un cuelgue con mate/ahogado en la raíz que congelaba el motor. WAC 269/300, récord; fuerza sin cambio — SPRT −2.1 ± 9.9 (H0) y gauntlet LTC +52 ± 23 frente al +48 de la v2.7.2 en el campo idéntico). Ver [CHANGELOG](CHANGELOG.md).
...
- **Siguiente** — **Tablebases Syzygy (v2.8.0)**, a propósito antes del NNUE (orden de la referencia: fuerza en finales ya, y adjudicación + re-etiquetado WDL del datagen después) · Entrenamiento NNUE · Lazy SMP · libro de competición al final · ver [ROADMAP.md](ROADMAP.md).
