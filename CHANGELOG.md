...
alone. A 600M-position corpus generated by today's engine (a ~130 Elo stronger teacher than the
one that labelled the current corpus) is in flight, and the two-headed psqt net is built end to
